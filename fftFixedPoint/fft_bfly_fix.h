...
#define Radix2_Fixed_Bfly_W0(x0_r, x0_i, x1_r, x1_i, s) \
{	\
	int t; \
	x0_r >>= 1; \
	t = x0_r + (x1_r >> s); \
...
#define Radix4_Fixed_Bfly_W0(x0_r, x0_i, x1_r, x1_i, x2_r, x2_i, x3_r, x3_i, s) \
{	\
  int t; \
  x2_r >>= s; \
  x2_i >>= s; \
...
Complex mutliplication macro:
 ...
 d_i = a_i*b_r + a_r*b_i
 */
#define CplxMulFixed(d_r, d_i, a_r, a_i, b) \
{ \
...
Complex conjugate mutliplication macro:
 ...
 d_i = a_i*b_r - a_r*b_i
 */
#define CplxMulConjFixed(d_r, d_i, a_r, a_i, b) \
{ \
